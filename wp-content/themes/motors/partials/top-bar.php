...
if (
		wp_is_mobile() &&
		stm_me_get_wpcfto_mod( 'top_bar_login' ) === false &&
		stm_me_get_wpcfto_mod( 'top_bar_wpml_switcher' ) === false &&
		stm_me_get_wpcfto_mod( 'top_bar_currency_enable' ) === false &&
		stm_me_get_wpcfto_mod( 'top_bar_login' ) === false &&
		stm_me_get_wpcfto_mod( 'top_bar_address_mobile' ) === false &&
		stm_me_get_wpcfto_mod( 'top_bar_working_hours_mobile' ) === false
	) {
	$top_bar = false;
}
